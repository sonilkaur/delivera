                                ...
                                <tbody>
                                    ...
                                    foreach ($payments as $pay) { ?>
                                        ...
                                        $i++; ?></td>
                                            ...
                                            <td><?php echo Globals::getCurrency() . $pay->store_earning; ?></td>
                                            <td><?php if($pay->admin_payment_status=="Pending"){$class="danger";}else{$class="success";}?><span class="badge badge-<?= $class;?>"><?php echo  $pay->admin_payment_status; ?></span></td>
                                             <td><?php echo date('D d M,Y',  strtotime($pay->date));?></td>
                                            <td><a href="<?= base_url();?>order/edit_payment_status/<?= $pay->orderId?>"><i class="fa fa-edit"></i></a></td>
                                           
                                            
<!-- <td><select id="payment_status" class="form-control" onchange="update_status(<?= $pay->orderId;?>,this)"><option disabled="" selected>Select Status</option><option value="0">Pending</option><option value="1">Complete</option></select></td>-->
