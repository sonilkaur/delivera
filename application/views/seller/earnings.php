...
<!--                                    <h3><?php// echo Globals::getCurrency() .$stats[0]->total_earning;?></h3>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                         <div class="row">
                            <form action="<?php echo base_url();?>seller/order/earnings/" method="get" class="filter_form col-md-12">Filter: 
                            <div class="row">
                              <div class="col-md-4"> 
 ...
 <div class="col-md-1">        
                        ...
                        <div class="float-right" style="margin-right:20px">
                            <a href="<?= base_url();?>seller/order/create_earnings_report/" title="download report"> <img src="<?= base_url();?>assets/images/csv.png" height="38px"></a>
                            </div>
