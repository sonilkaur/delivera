               ...
               <div class="col-sm-12">
                  <div class="page-title-box">
                     ...
                     <h4 class="page-title">Promo Codes</h4>
                      <a href="<?php echo base_url();?>seller/order/add_promo/"> <button type="button" class="btn btn-primary waves-effect waves-light ">Add</button></a>
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>
                                     ...
                                     <span  class="action">
                                         <a href="<?= base_url()?>seller/order/edit_promo/<?= $code->codeId?>"  >
                                         <i class="fa fa-edit" aria-hidden="true"></i>
                                     </a>|
                                     <a href="#" id="delete" onclick="remove(<?php echo $code->codeId;?>,'seller/order/delete_promo')">
