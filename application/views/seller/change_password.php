                           ...
                           <h3 class="text-center mt-0 m-b-15"><a href="<?php echo base_url();?>admin" class="logo logo-admin"><img src="<?php echo base_url();?>assets/images/logo.png" alt="logo"></a></h3>
                              ...
                              <div class="p-3">
                                 <form class="form-horizontal m-t-20" action="#">
                                    <div class="alert alert-success alert-success"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>  <b>Success! </b> Email sent to you!</div>
                                    <div class="form-group row">
                                        <div class="col-12"><input readonly="" value="<?php echo  $result->email;?>" class="form-control" type="email" required="" placeholder="Email"></div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-12"><input class="form-control" type="text" required="" value="" placeholder="Enter OTP"><input class="form-control" type="hidden" required="" value="<?php echo  $result->storeId;?>" ></div>
                                    </div>
                                    <div class="form-group row">
                                       <div class="col-12"><input class="form-control" type="password" required="" placeholder="Enter New Password"></div>
                                    </div>
                                    <div class="form-group text-center row m-t-20">
                                       <div class="col-12"><button class="btn btn-primary btn-block waves-effect waves-light" type="submit">Submit</button></div>
