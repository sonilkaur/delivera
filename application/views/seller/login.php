               ...
               <div class="container">
                  <div class="row justify-content-center">
                     <div class="col-lg-5 col-md-8">
                        <div class="card">
                           <div class="card-body">
                              <h3 class="text-center mt-0 m-b-15"><a href="#" class="logo logo-admin"><img src="<?php echo base_url();?>assets/images/logo.png" height="" alt="logo"></a></h3>
                              <h4 class="text-muted text-center font-18"><b>Seller Sign In</b></h4>
                              <div class="p-2">
                        ...
                        <?php }?>
                                  <form class="form-horizontal m-t-20" action="<?php echo base_url();?>seller/home/login_auth" method="post">
                                    ...
                                    <div class="form-group m-t-10 mb-0 row text-center">
                                       <div class="col-sm-12 m-t-20"><a href="<?php echo base_url();?>seller/home/forgot_password/" class="text-muted"><i class="mdi mdi-lock"></i> Forgot your password?</a></div>
