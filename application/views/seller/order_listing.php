        ...
        <div class="row">
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                         <div class="row">
                            <form action="<?php echo base_url();?>seller/order/" method="get" class="filter_form col-md-12">Filter:
                            <div class="row">
                              <div class="col-md-4"> 
                                   <label>Date</label>
 ...
 <div class="col-md-1">       <label style="padding-bottom: 15px;"></label>  
                        ...
                        <?php if ($result) { ?>
                          <div class="float-right" style="margin-right:20px">
                            <a href="<?= base_url();?>seller/order/create_report/" title="download report"> <img src="<?= base_url();?>assets/images/csv.png" height="38px"></a>
                            </div>
...
<!--                                            <td><?php echo $orders->store_name; ?></td>-->
                                            ...
                                            <td><?php
                                                ...
                                                // echo $orders->status;
                                                ?></td>
                                              <td><?php echo $orders->createdOn; ?></td>
                                           <!-- <td><a href="#" id="delete" onclick="remove(<?php echo $orders->orderId;?>,'seller/order/delete')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>-->
                                            <td><a href="<?php echo base_url();?>seller/order/view_order/<?php echo $orders->orderId;?>">view order</a> / <a href="<?php echo base_url();?>seller/order/invoice/<?php echo $orders->orderId;?>">invoice</a></td>
