                ...
                <div class="card m-b-30">
                    <div class="card-body">
                            ...
                            <ul>
                                <li>
                                    <div class="funkyradio-warning">
                                        <input type="radio" name="status" value="0" id="radio1" <?php
                                        if ($result->status == '0') {
                                            echo 'checked';
                                        }
                                        ?>>
                                ...
                                <li>
                                    <div class="funkyradio-primary">
                                        <input type="radio" name="status" value="5" id="radio2"  <?php
                                        if ($result->status == '5') {
                                            echo 'checked';
                                        }
                                        ?>>
                                ...
                                <li>
                                    <div class="funkyradio-danger">
                                        <input type="radio" name="status" value="6" id="radio3"  <?php
                                        if ($result->status == '6') {
                                            echo 'checked';
                                        }
                                        ?>>
                                ...
                                <li>
                                    <div class="funkyradio-cancelled">
                                        <input type="radio" name="status" value="3" id="radio4"  <?php
                                        if ($result->status == '3') {
                                            echo 'checked';
                                        }
                                        ?>>
                                ...
                                <li>
                                    <div class="funkyradio-info">
                                        <input type="radio" name="status" value="2" id="radio5"  <?php
                                        if ($result->status == '2') {
                                            echo 'checked';
                                        }
                                        ?>>
                                ...
                                <li>
                                    <div class="funkyradio-ready">
                                        <input type="radio" name="status" value="4" id="radio6"  <?php
                                        if ($result->status == '4') {
                                            echo 'checked';
                                        }
                                        ?>>
                                ...
                                <li>
                                    <div class="funkyradio-pickup">
                                        <input type="radio" name="status" value="7" id="radio7"  <?php
                                        if ($result->status == '7') {
                                            echo 'checked';
                                        }
                                        ?>>
                                ...
                                <li>
                                    <div class="funkyradio-success">
                                        <input type="radio" name="status" value="1" id="radio8"  <?php
                                        if ($result->status == '1') {
                                            echo 'checked';
                                        }
                                        ?>>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#delivery_boy" role="tab" aria-selected="false">Assign Delivera Rider</a></li>
                        </ul>
                            ...
                            <div class="tab-pane p-3 active show" id="home" role="tabpanel">
                                ...
                                <table width="100%" border="1">
                                    <tbody>
                                        <tr>
                                            <th>Store Name</th>
                                            <td colspan="3"><?php echo $result->store_name; ?></td>
                                        </tr>
                                        <tr>
                                            <th>Name</th>
                                        ...
                                        <tr>
                                            <th>Delivery Cost</th>
                                            <td colspan="3">
                                                <?php echo "$ " . $result->delivery_fee; ?>                                  
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>TAX</th>
                                            <td colspan="3">
                                                <?php echo "$ " . $result->total_tax; ?>                                 
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="tab-pane p-3" id="profile" role="tabpanel">
                                ...
                                <ul class="list-unstyled msg_list">
                                    ...
                                    foreach ($result->order_items as $item) {
                                        ?>
                                        <?php
                                        echo '<span class="item_heading">Item #' . $i . '</span>';
                                        $i++;
                                        ?>
                                        <li>
                                            <a>
...
<?php } ?>
                            ...
                            <div class="tab-pane p-3" id="delivery_boy" role="tabpanel">
                                <p class="font-14 mb-0">
                                <div class="row">
                                        <?php //echo '<pre>';print_r($delivery_boy); ?>
                                    <div class="box_1">
                                        <?php
                                        if ($delivery_boy) {
                                            foreach ($delivery_boy as $row) {
                                                ?>
                                                <div class="big <?php if ($row->boyId == $result->deliveryBoyId) {
                                                    echo"hli";
                                                } ?>">
        ...
        <?php } ?>
                                                                <div class="info_boxx">
                                                                    ...
                                                                    <p><i class="fa fa-mobile"></i><?php echo $row->phone; ?></p>
                                                                          <p><i class="fa fa-map-marker"></i><b><?php echo round($row->distance,2) ." KM distance"; ?></b></p>
                                                                </div>
                                                            </div>
...
?>
        ...
        <script>
                ...
                $("input[name=status]").change(function () {
                   ...
                   // return false;
                    ...
                    $.ajax({
                        ...
                        dataType: "text",
                        async: false,
                        url: "<?php echo base_url(); ?>" + "order/updateOrderStatus", //Relative or absolute path to response.php file
            ...
            $('.big').click(function () {
                ...
                var boyid = $(this).find(' input[type="radio"]:checked').val();
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    async: false,
                    url: "<?php echo base_url(); ?>" + "order/assign_delivery_boy", //Relative or absolute path to response.php file
                    data: {'boyid': boyid, 'orders_id': "<?php echo $result->orderId; ?>"},
                    success: function (data) {
                        alert(data);
                         location.reload();
                    }
