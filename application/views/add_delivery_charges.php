                ...
                <div class="page-title-box">
                    <div class="btn-group float-right">
                        <ol class="breadcrumb hide-phone p-0 m-0">
                            ...
                            <li class="breadcrumb-item"><a href="#">Add Delivery Charges</a></li>

                        </ol>
                    </div>
                    <h4 class="page-title">Add Delivery Charges</h4>
                </div>
            </div>
        </div>
            ...
            <div class="col-12 ">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <?php } ?>
                        <form action="<?php echo base_url(); ?>admin/add_delivery_process" method="post" enctype="multipart/form-data">
